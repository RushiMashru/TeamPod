...
<div style='width:120px;float:left;text-align:left;    color: black;font-weight:bold;'>Main Group: </div> <div style='display:inline;    color: black;float:left'><?php echo $TaskMainGroupTitle ?></div><br clear='all'><br clear='all'>
<div style='width:120px;float:left;text-align:left;    color: black;font-weight:bold;'>Sub Group: </div> <div style='display:inline;    color: black;float:left'><?php echo $TaskSubGroupTitle ?></div><br clear='all'><br clear='all'>
<div style='width:120px;float:left;text-align:left;    color: black;font-weight:bold;'>Start Date: </div> <div style='display:inline;    color: black;float:left'><?php echo $cScheduleDate ?></div><br clear='all'><br clear='all'>
<div style='width:120px;float:left;text-align:left;    color: black;font-weight:bold;'>Due Date: </div> <div style='display:inline;    color: black;float:left'><?php echo $cDueDate ?></div><br clear='all'><br clear='all'>
 ...
 <div class="inp">
        ...
        <div class="inp" style="margin-top: 20px;">
                        ...
                        <textarea name="taskdescr" id="taskdescr" style="height: 142px;resize: none;" <?php echo $readonly ?> rows="15" placeholder="Please Provide Task Detail"><?php echo $TaskDescription ?></textarea>
