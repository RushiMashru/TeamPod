           ...
           <!--  <div class="maintab-box">
               <div class="tabsub-box">
                  ...
                  <div class="tab-text-4">
                     ...
                     <div class="img-box">
                        <img src="images/tab-12.png">
                     </div>
                  </div>
                  <div class="tab-text-1 tab-text-5">
                     <div class="tab-text-left">
                        <h3><img src="images/Plus.svg"> Sub task</h3>
                     </div>
                     <div class="tab-text-right">
                        <div class="tab">
                           <button class="tablinks" type="button" onclick="openCity(event, 'tab-1')"><img src="images/Copy of Clock.svg"></button>
                           <button class="tablinks" type="button" onclick="openCity(event, 'tab-2')"><img src="images/Hourglass Start.svg"></button>
                           <button class="tablinks" type="button" onclick="openCity(event, 'tab-3')"><img src="images/Users.svg"></button>
                           <button class="tablinks" type="button" onclick="openCity(event, 'tab-4')"><img src="images/Tags.svg"></button>
                           <button class="tablinks" type="button" onclick="openCity(event, 'tab-5')"><img src="images/Copy of Cloud_Upload.svg"></button>
                           <button class="tablinks" type="button" onclick="openCity(event, 'tab-6')"><img src="images/Notes.svg"></button>
                           <button class="tablinks" type="button" onclick="openCity(event, 'tab-7')"><img src="images/Copy of Calendar_Default.svg"></button>
                           <button class="tablinks" type="button" onclick="openCity(event, 'tab-8')"><img src="images/Copy of By User.svg"></button>
                           <button class="tablinks" type="button" onclick="openCity(event, 'tab-9')"><img src="images/Task_Completed.svg"></button>
                        </div>
                     </div>
                  </div>
